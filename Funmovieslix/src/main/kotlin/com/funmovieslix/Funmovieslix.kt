...
class Funmovieslix : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "category/romance" to "Romance Category",
        "category/horror" to "Horror Category",
        "category/thriller" to "Thriller Category",
        "category/fantasy" to "Fantasy Category",
        "category/science-fiction" to "Sci-Fi Category",
        "category/adventure" to "Adventure Category",
        "category/animation" to "Animation Category"
    )
    ...
    override suspend fun loadLinks(
        ...
        val scriptContent = document.select("script")
            .map { it.data() }
            .firstOrNull { it.contains("const embeds") } ?: return false
